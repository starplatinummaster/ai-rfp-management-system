...
(1, 'Office Laptop Procurement', 
 ...
 '{"items":[{"name":"Business Laptops","quantity":25,"specifications":"Intel i5+, 16GB RAM, 512GB SSD"}],"budget":{"max":4565000,"currency":"INR"},"timeline":{"deadline":"2026-01-15"},"terms":{"payment":"Net 30","warranty":"3 years"}}',
 'draft'),

(1, 'Conference Room Setup', 
 'Setup 3 conference rooms: projectors, screens, audio. Budget Rs 12.5L, 2 weeks.',
 '{"items":[{"name":"AV Equipment","quantity":3,"specifications":"Projector, screen, audio system per room"}],"budget":{"max":1250000,"currency":"INR"},"timeline":{"deadline":"2025-12-30"},"terms":{"payment":"50% upfront","warranty":"2 years"}}',
 'sent');

-- Insert RFP-Vendor relationships
INSERT INTO rfp_vendors (rfp_id, vendor_id, sent_at, email_status, email_message_id) VALUES 
(1, 1, '2025-12-05 10:00:00', 'sent', 'msg_001_techcorp_laptops'),
(1, 4, '2025-12-05 10:01:00', 'delivered', 'msg_002_premium_laptops'),
(2, 1, '2025-12-03 14:30:00', 'sent', 'msg_003_techcorp_conference'),
(2, 3, '2025-12-03 14:31:00', 'delivered', 'msg_004_globalit_conference');
...
(1, 1, 
 ...
 '{"pricing":{"total":4357500,"per_unit":174300},"timeline":{"delivery_date":"2025-12-28"},"terms":{"payment":"Net 30","warranty":"3-year"},"specifications":{"processor":"Intel i5-1335U","memory":"16GB","storage":"512GB SSD"}}',
...
(1, 4, 
 ...
 '{"pricing":{"total":4046250,"per_unit":161850},"timeline":{"delivery_date":"2026-01-01"},"terms":{"payment":"2/10 net 30","warranty":"3-year"},"specifications":{"processor":"Intel i5-1340P","memory":"16GB","storage":"512GB SSD"}}',
