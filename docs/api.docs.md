...
```json
{
  "description": "Need 25 laptops: Intel i5+, 16GB RAM, 512GB SSD, Win11 Pro. Budget $50k, 30 days delivery."
}
```
...
```json
{
  "id": 1,
  "user_id": 1,
  "title": "Need 25 laptops: Intel i5+, 16GB RAM, 512GB SSD...",
  "description": "Need 25 laptops: Intel i5+, 16GB RAM, 512GB SSD, Win11 Pro. Budget $50k, 30 days delivery.",
  "structured_requirements": "{\"items\":[{\"name\":\"Business Laptops\",\"quantity\":25}],\"budget\":{\"max\":55000}}",
  "status": "draft",
...
```json
{
  "rfp_id": 1,
  "vendor_id": 1,
  "raw_email_content": "Dell Latitude laptops, $52,500 total, 21 days delivery...",
...
{
  "id": 1,
  "structured_proposal": "{\"pricing\":{\"total\":52500},\"timeline\":{\"delivery_date\":\"2024-02-12\"}}",
  "ai_scores": "{\"price_score\":8.5,\"overall_score\":9.0}",
  "processing_status": "completed"
}
```
...
```json
{
  ...
  "text": "Dell laptops (25 units): $52,500 total. Delivery: 21 days. RFP ID: 1, Vendor ID: 1",
...
1. **Create Vendor:**
   ...
   Body: {"name": "Test Vendor", "email": "test@vendor.com", "category": "Technology"}
   ```

2. **Create RFP:**
   ```
   POST {{baseUrl}}/rfps
   Body: {"description": "Need 10 laptops, budget $20k, 2 weeks delivery"}
   ```
...
4. **Create Proposal:**
   ...
   Body: {"rfp_id": 1, "vendor_id": 1, "raw_email_content": "HP laptops $18k, 10 days delivery", "email_subject": "RFP Response"}
   ```
